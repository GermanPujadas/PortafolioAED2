 ...
 * @author Josse
 */
public class TriePrefixAEDIIGUIHash extends javax.swing.JFrame {
    
    private TArbolTrieHash trie;
    
    /**
     * Creates new form TriePrefixAEDIIGUI
     */
    public TriePrefixAEDIIGUIHash() {
        this.trie           = new TArbolTrieHash();
        String[] palabras = {};
        //TODO: CARGAR PALABRAS CON EL LECTOR DE ARCHIVOS GENÉRICO
        palabras = ManejadorArchivosGenerico.leerArchivo("src/dispositivos.txt");
        
        for (String p : palabras) {
            String[] datos = p.split(",");
            TDispositivo dispositivo = new TDispositivo(datos[0], datos[1]);
    ...
    private void jtfSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtfSearchKeyReleased
        ...
        Collection<TDispositivo> dispositivos;
        //TODO: LLENAR LISTA DE PALABRAS CON EL MÉTODO PREDECIR
        dispositivos = this.trie.buscarDispositivos(jtfSearch.getText());
        for(TDispositivo disp : dispositivos){
            listModel.addElement("IP: "+disp.getDirIP() + "Nombre: " +disp.getNombre());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TriePrefixAEDIIGUIHash.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TriePrefixAEDIIGUIHash().setVisible(true);
            }
        });
    }
